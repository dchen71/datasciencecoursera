...
print(confusionMatrix(predTrain, trainset$classe))
```
...
# Perform the cross validation which shows .01 seemed to have lowest r^2
...
trainCART = rpart(classe ~ ., trainset, method="class",cp=.01)
